...
<div class="player">
	...
	<figure on:click={handleClick} class="media-controller">
		<audio>
			<track kind="captions" />
			<source src={song_url} type="audio/ogg" kind="caption" />
		...
		>
			...
			<ellipse
				...
				transform="rotate(-90)"
			/>
			<g class="pause" transform="translate(-0.17777825,-0.18127833)">
				<path d="M 51.271205,42.984758 V 92.552532" id="path1673" />
				<path
					class="pause"
